    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        const customParkingData = [
             ...
             { id: 1, name: 'Nairobi Parking: $3.0', lat: -1.2921, lng: 36.8219 },
             { id: 2, name: 'Kisumu Parking: $6.3', lat: -0.0917, lng: 34.7672 },
             { id: 3, name: 'Nakuru Parking: $9.2', lat: -0.3031, lng: 36.0800 },
             { id: 4, name: 'Kikuyu Parking: $2.4', lat: -1.2546, lng: 36.6830 },
             { id: 5, name: 'Kiambu Parking: $3.0', lat: -1.1704, lng: 36.8353 },
             { id: 6, name: 'Kenol Parking: $4.7', lat: -0.9028, lng: 37.1889 },
             { id: 7, name: 'Ruiru Parking: $1.9', lat: -1.1455, lng: 36.9580 },
             { id: 8, name: 'Munyu Parking: $9.0', lat: -0.9372, lng: 37.0455 },
             { id: 9, name: 'Gatura Parking: $13.6', lat: -1.0202, lng: 36.7321 },
             { id: 10, name: 'Banana Parking: $11.5', lat: -1.1489, lng: 36.8805 },
             { id: 11, name: 'Ruaka Parking: $4.0', lat: -1.1956, lng: 36.7793 },
             { id: 12, name: 'Ndumberi Parking: $3.8', lat: -1.1058, lng: 36.7158 },
             { id: 13, name: 'Kiserian Parking: $7.8', lat: -1.3770, lng: 36.6690 },
             { id: 14, name: 'Lavington Parking: $8.7', lat: -1.2680, lng: 36.7763 },
             { id: 15, name: 'Kariobangi Parking: $2.3', lat: -1.2482, lng: 36.8856 },
             { id: 16, name: 'Buruburu Parking: $3.9', lat: -1.2854, lng: 36.8762 },
             { id: 17, name: 'Pangani Parking: $6.2', lat: -1.2631, lng: 36.8324 },
             { id: 18, name: 'Riruta Parking: $9.3', lat: -1.2946, lng: 36.7480 },
             { id: 19, name: 'Loresho Parking: $13.0', lat: -1.2578, lng: 36.7476 },
             { id: 20, name: 'Hunters Parking: $10.1', lat: -1.2757, lng: 36.8188 },
             { id: 21, name: 'Soweto Parking: $10.6', lat: -1.3093, lng: 36.8802 },
             { id: 22, name: 'Komarock Parking: $3.3', lat: -1.2635, lng: 36.9263 },
             { id: 23, name: 'Parklands Parking: $8.1', lat: -1.2615, lng: 36.8022 },
             { id: 24, name: 'Parking Space 1: $4.2', lat: -1.0, lng: 37.0 },
             { id: 25, name: 'Parking Space 2: $3.7', lat: -1.1, lng: 37.1 },
             { id: 26, name: 'Parking Space 3: $7.7', lat: -1.2, lng: 37.2 },
             { id: 27, name: 'Parking Space 4: $8.2', lat: -1.3, lng: 37.3 },
             { id: 28, name: 'Parking Space 5: $3.0', lat: -1.4, lng: 37.4 },
